...
export async function PartnerGoalsSection({ profile }: { profile: Profile }) {
  ...
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm muted">Team up with a gym buddy and hit a shared target together.</p>
