...
import type { Profile, RsvpStatus } from "@/lib/database.types";
...
export async function EventsSection({ profile }: { profile: Profile }) {
  ...
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm muted">Gym events and get-togethers. RSVP and see who&apos;s coming.</p>
        <CreateEventDialog myId={profile.id} defaultDate={format(new Date(), "yyyy-MM-dd")} />
      </div>
