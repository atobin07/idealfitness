...
export async function ClassesSection({ profile }: { profile: Profile }) {
  ...
  return (
    <>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm muted">{canManage ? "Create and manage group classes." : "Come get a great workout in with the crew."}</p>
        {canManage && (
